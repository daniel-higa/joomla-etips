<?php
/**
 * @version		$Id: linkchecker.mtree.html.php 950 2010-11-16 09:07:27Z cy $
 * @package		Mosets Tree
			...
			<table width="100%" border=0>
				<tr>
					<td width="50%" valign="top">
						<input type="button" value="Check Links" onclick="startLinkChecker()" /> &nbsp;<?php JText::sprintf( 'There are x links in the directory', $num_of_links ) ?><?php JText::sprintf( 'Last checked date',( (empty($config['linkchecker_last_checked']->value))? JText::_( 'Never' ) : tellDateTime($config['linkchecker_last_checked']->value) ) ) ?>
						<p />
