<?php
/**
 * @version	$Id: parameter.php 979 2011-01-05 06:57:47Z cy $
 * @package	Mosets Tree
 * @copyright	(C) 2005-201- Mosets Consulting. All rights reserved.
 ...
 * framework's JRegistry which allows XML setup data passed directly as string
 * rather than as path.
 *
 * @author 	Lee Cher Yeong <mtree@mosets.com>
 * @package 	Mosets Tree
