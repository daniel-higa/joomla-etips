<?php
/**
 * @version		$Id: geocode.mtree.php 979 2011-01-05 06:57:47Z cy $
 * @package		Mosets Tree
	...
	<table width="100%">
		<tr>
			...
			<table width="100%" border=0>
				<tr>
					<td>
						<?php echo JText::sprintf( 'Total listings in directory', $total['all'] ) ?>
						<p /><?php echo JText::sprintf( 'Geocoded listings', $total['geocoded'] ) ?>
						<p /><?php echo JText::sprintf( 'LISTINGS THAT HAVENT BEEN GEOCODED BUT HAVE ADDRESS INFORMATION WITH THEM THESE LISTINGS CAN BE GEOCODED TO LOCATE THEIR ADDRESS IN MAP', $total['req_geocoding'] ) ?>
