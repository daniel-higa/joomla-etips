<?php
/**
 * @version		$Id: customfields.mtree.html.php 1011 2011-01-25 02:26:34Z cy $
 * @package		Mosets Tree
...
class HTML_mtcustomfields {
	...
	<table width="100%" class="admintable">
		...
		<tr>
			...
			<td><textarea name="field_elements" rows="8" cols="50" class="text_area" style="width:100%"><?php echo $row->field_elements ?></textarea>
				<p /><?php echo JText::_( 'Field elements note' ) ?></td>
		</tr>
		<tr>
	...
	$parameters = $params->renderToArray();
	foreach($parameters AS $parameter)
	{
		echo '<tr>';
		echo '<td>';
		echo '<label for="'.$parameter[5].'">';
		echo $parameter[0];
		echo '</label>';
		echo '</td>';
		echo '<td>';
