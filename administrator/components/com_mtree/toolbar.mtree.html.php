<?php
/**
 * @version		$Id: toolbar.mtree.html.php 950 2010-11-16 09:07:27Z cy $
 * @package		Mosets Tree
...
class TOOLBAR_mtree {
	...
	function EDITLINK_MENU() {
		...
		JToolBarHelper::title(  ($task=='newlink') ? JText::_( 'Add listing' ) : JText::_( 'Edit listing' ), 'article.png' );
	...
	function MOVELINKS_MENU() {
		JToolBarHelper::title( JText::_( 'Move Link' ), 'article.png' );
	...
	function COPYLINKS_MENU() {
		JToolBarHelper::title( JText::_( 'Copy Link' ), 'article.png' );
	...
	function LISTPENDING_LINKS_MENU() {
		JToolBarHelper::title( JText::_( 'Pending listing' ), 'article.png' );
		$bar = & JToolBar::getInstance('toolbar');
	...
	function LISTPENDING_REVIEWS_MENU() {
		JToolBarHelper::title( JText::_( 'Pending reviews' ), 'article.png' );
		JToolBarHelper::apply( 'save_pending_reviews' );
	}

	function LISTPENDING_REPORTS_MENU() {
		JToolBarHelper::title( JText::_( 'Pending reports' ), 'article.png' );
		JToolBarHelper::apply( 'save_reports' );
	}

	function LISTPENDING_REVIEWSREPORTS_MENU() {
		JToolBarHelper::title( JText::_( 'Pending reviews reports' ), 'article.png' );
		JToolBarHelper::apply( 'save_reviewsreports' );
	}

	function LISTPENDING_REVIEWSREPLY_MENU() {
		JToolBarHelper::title( JText::_( 'Pending reviews replies' ), 'article.png' );
		JToolBarHelper::apply( 'save_reviewsreply' );
	}

	function LISTPENDING_CLAIMS_MENU() {
		JToolBarHelper::title( JText::_( 'Pending claims' ), 'article.png' );
	...
	function LISTREVIEWS_MENU() {
		JToolBarHelper::title( JText::_( 'Reviews' ), 'article.png' );
	...
	function EDITREVIEW_MENU() {
		...
		JToolBarHelper::title(  (($task=='newreview') ? JText::_( 'Add' ) : JText::_( 'Edit' )) . ' ' . JText::_( 'Review' ), 'article.png' );
	...
	*/
	function SEARCH_LISTINGS() {
		JToolBarHelper::title( JText::_( 'Search results' ) . ' - ' . JText::_( 'Listings' ) , 'article.png' );
		$bar = & JToolBar::getInstance('toolbar');
	...
	function SEARCH_CATEGORIES() {
		JToolBarHelper::title( JText::_( 'Search results' ) . ' - ' . JText::_( 'Categories' ) , 'article.png' );
