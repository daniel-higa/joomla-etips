<?php
/**
 * @version	$Id: script.php 1031 2011-01-31 08:56:49Z cy $
 * @package	Mosets Tree
...
class Com_MtreeInstallerScript {
	...
	function install($parent)
	{
		...
		<table class="adminlist">
			<tbody>
				<?php echo $this->getHtaccessRenameRow($htaccess_rename_status); ?>
				<?php echo $this->getWritableRow($mtconf->getjconf('absolute_path').$mtconf->get('relative_path_to_cat_original_image')); ?>
				<?php echo $this->getWritableRow($mtconf->getjconf('absolute_path').$mtconf->get('relative_path_to_cat_small_image')); ?>
				<?php echo $this->getWritableRow($mtconf->getjconf('absolute_path').$mtconf->get('relative_path_to_listing_original_image')); ?>
				<?php echo $this->getWritableRow($mtconf->getjconf('absolute_path').$mtconf->get('relative_path_to_listing_medium_image')); ?>
				<?php echo $this->getWritableRow($mtconf->getjconf('absolute_path').$mtconf->get('relative_path_to_listing_small_image')); ?>
			</tbody>
		</table>
