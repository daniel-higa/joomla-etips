...
<fieldset>
	...
	<div style="margin:0 0 5px 0"><input type="button" onclick="locateInMap()" value="<?php echo JText::_( 'Locate in map' ); ?>" name="locateButton" id="locateButton" /><span style="padding:0px; margin:3px" id="map-msg"></span></div>
...
<fieldset class="images">
	...
	<div class="actionimages">
		...
		<br /><small><?php echo JText::sprintf( 'Limit of x per image', $this->image_size_limit )?></small>
		<?php } ?>
	</div>
</fieldset>
</div>
