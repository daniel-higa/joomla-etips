window.addEvent("domready",function(){
    ...
    if(document.id('jform_params_k2multicategories')) {
    	document.id('jform_params_k2multicategories').getParent().setStyle('display', (selector.value == 'k2_categories') ? 'block' : 'none');
    	document.id('jform_params_k2tags').getParent().setStyle('display', (selector.value == 'k2_tags') ? 'block' : 'none');
    	document.id('jform_params_k2items').getParent().setStyle('display', (selector.value == 'k2_articles') ? 'block' : 'none');
    }
	// 
