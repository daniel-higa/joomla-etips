...
;(function($) {
	...
	var defaults = {
		...
		structure: 	 			  '<a href="#" class="prev_button">prev</a>'
								...
								+ '<div class="container_skitter">'
									+ '<div class="image">'
										+ '<a href="" onclick=""><img class="image_main" /></a>'
	...
	$sk.fn.extend({
		...
		setup: function() 
		{
			...
			var addImageLink = function (link, src, animation_type, label, target, onclick) {
				...
				$.ajax({
					...
					success: function(xml) {
						...
						$(xml).find('skitter slide').each(function(){
							...
							addImageLink(link, src, animation_type, label, target, onclick);
						});
					}
				});
			}
		...
		jumpToImage: function(imageNumber) 
		{
			if (this.settings.is_animating == false) {
				...
				this.box_skitter.find('.image a').unbind('click');
				this.box_skitter.find('.image a').click(this.settings.images_links[imageNumber][5]);
		...
		setImageLink: function()
		{
			...
			var onclick = this.settings.images_links[this.settings.image_i][5];
			
			this.settings.image_atual = name_image;
			this.settings.link_atual = link_image;
			this.settings.label_atual = label_image;
			this.settings.target_atual = target_link;
			this.settings.onclick_atual = onclick;
		},
		...
		getBoxClone: function()
		{
			if (this.settings.link_atual != '#') {
				...
				img_clone.unbind('click');
				img_clone.click(this.settings.onclick_atual);
			...
			if ( self.settings.stop_over ) 
			{
				self.box_skitter.hover(function() {
					...
					if (!self.settings.is_animating && self.settings.images_links.length > 1) {
						...
						//self.box_skitter.find('.image a').unbind('click');
						//self.box_skitter.find('.image a').click(self.settings.onclick_atual);
					}
				});
			}
			else
		...
		setLinkAtual: function() {
			...
			this.box_skitter.find('.image a').click(this.settings.onclick_atual);
		},
